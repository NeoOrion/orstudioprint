...
export default function ResinaPage() {
  return <><SiteHeader active="resina" /><main className="public-shell">
    <section className="public-hero"><div className="hero-copy"><p className="eyebrow">Impressão 3D em resina · Curitiba e região</p><h1>Quer imprimir uma miniatura ou peça detalhada?</h1><p>Envie o arquivo 3D, a escala ou altura e a quantidade. Avaliamos o projeto para preparar uma simulação de preço em resina.</p><a className="primary-link" href="#simulacao">Simular em resina</a><small>Você recebe uma simulação por e-mail. Nesta fase não há cobrança, pedido ou reserva de produção.</small><p className="scan-line">Miniaturas · Figuras · Bustos · Peças detalhadas</p></div><figure className="hero-image"><img src="/images/resina-hero.webp" alt="Grupo ilustrativo de miniaturas detalhadas para impressão em resina." /><figcaption>Imagem ilustrativa</figcaption></figure></section>
